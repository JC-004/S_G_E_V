...
public class mostrarSALIDAS extends javax.swing.JFrame {        
    
    public mostrarSALIDAS() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Mostrando salidas registradas");
        setResizable(false);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setText("Mostrando salidas existentes");
    ...
    public javax.swing.JTable tablaSALIDAS;
